...
def load_theme_colors():
    ...
    defaults = {
        ...
        "yellow": "#89b4fa",         # unused fallback
        "blue": "#89b4fa",           # cool / idle
        "magenta": "#cba6f7",        # critical purple
        "cyan": "#94e2d5",
        "white": "#ffffff",
...
COLOR_TABLE = [
    {"color": COLORS["blue"],     "cpu_gpu_temp": (0, 45),   "gpu_power": (0.0, 35)},
    {"color": COLORS["red"],      "cpu_gpu_temp": (46, 70),  "gpu_power": (36, 70)},
    {"color": COLORS["green"],    "cpu_gpu_temp": (71, 82),  "gpu_power": (71, 85)},
    {"color": COLORS["magenta"],  "cpu_gpu_temp": (83, 999), "gpu_power": (86, 999)}
]
