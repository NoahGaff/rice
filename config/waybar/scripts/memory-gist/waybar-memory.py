...
def load_theme_colors():
    return {
        "black": "#000000",
        "red": "#f5a7c5",            # pink = normal
        "green": "#a6e3a1",          # pastel green
        "yellow": "#89b4fa",         # not really used anymore
        "blue": "#89b4fa",           # mid warning
        "magenta": "#cba6f7",        # purple = critical
        "cyan": "#94e2d5",
        "white": "#ffffff",
...
COLOR_TABLE = [
    {"color": COLORS["red"],            "mem_storage": (0.0, 20),  "mem_temp": (0, 40)},
    {"color": COLORS["blue"],           "mem_storage": (20.0, 50), "mem_temp": (41, 55)},
    {"color": COLORS["green"],          "mem_storage": (50.0, 75), "mem_temp": (56, 70)},
    {"color": COLORS["magenta"],        "mem_storage": (75.0,100), "mem_temp": (71, 999)}
]
...
def get_memory_modules_from_dmidecode():
    ...
    try:
        output = subprocess.check_output(["sudo", "-n", "/usr/sbin/dmidecode", "--type", "memory"], text=True, stderr=subprocess.PIPE)
